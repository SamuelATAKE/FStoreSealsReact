                  ...
                  <div class="row">
                    <div class="col-lg-7 col-12">
                      <div class="hero-text">
                        ...
                        <p>
                          Votre marketplace digital <br /> depuis le confort de
                          votre maison. <br />
                        </p>
                        <div class="button">
                          <a href="#" class="btn">
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
              <div class="single-banner">
                <img src="/images/summerTravelCollection.jpg" alt="#" />
                <div class="content">
            ...
            <div class="col-lg-4 col-md-6 col-12">
              <div class="single-banner">
                <img src="/images/AwesomeBag.jpg" alt="#" />
                <div class="content">
            ...
            <div class="col-lg-4 col-12">
              <div class="single-banner tab-height">
                <img src="/images/MidSeason.jpg" alt="#" />
                <div class="content">
                  <p>Vente rapide</p>
                  <h3>
                    Mid Season <br /> Jusqu'à<span>40%</span> Off
                  </h3>
                  <a href="#">Explorer</a>
                </div>
              </div>
                      ...
                      <div class="row">
                            ...
                            <div class="product-img">
                              ...
                              <div class="button-head">
                                <div class="product-action">
                                  ...
                                  <a title="Liste de souhaits" href="#">
                                    <i class=" ti-heart "></i>
                                    <span>Ajouter à la liste de souhaits</span>
                                  </a>
                                  <a title="Comparer" href="#">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                          <div class="single-product">
                            ...
                            <div class="product-content">
                              <h3>
                                <a href="/article">Superbe spectacle rose</a>
                              </h3>
                              <div class="product-price">
                                <span>2.900 FCFA</span>
                              </div>
                          ...
                          <div class="single-product">
                            <div class="product-img">
                              <a href="/article">
                                <img
                                  class="default-img"
                                  src="/images/AwesomeBagCollection2.jpg"
                                  alt="#"
                                />
                                <img
                                  class="hover-img"
                          ...
                          <div class="single-product">
                            <div class="product-img">
                              <a href="/article">
                                <img
                                  class="default-img"
                                  src="/images/AwesomeCapWomen.jpg"
                                  alt="#"
                                />
                                <img
                                  class="hover-img"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                          <div class="single-product">
                            ...
                            <div class="product-content">
                              <h3>
                                <a href="/article">
                                  Lunettes de soleil noires pour femmes
                                </a>
                              </h3>
                              <div class="product-price">
            ...
            <div class="col-lg-6 col-md-6 col-12">
              <div class="single-banner">
                ...
                <div class="content">
                  ...
                  <h3>
                    Articles pour Homme <br />
                    Jusqu'à<span> 50%</span>
                  </h3>
                  <a href="#">Acheter</a>
                </div>
              </div>
            ...
            <div class="col-12">
              <div class="owl-carousel popular-slider">
                ...
                <div class="single-product">
                  ...
                  <div class="product-content">
                    <h3>
                      <a href="/article">Collection Tendance Femmes</a>
                    </h3>
                    <div class="product-price">
                      <span>5.000 FCFA</span>
                    </div>
                ...
                <div class="single-product">
                  ...
                  <div class="product-content">
                    <h3>
                      <a href="/article">Superbe collection de sacs</a>
                    </h3>
                    <div class="product-price">
                      <span>5.000 FCFA</span>
                    </div>
